...
from widget_tas_fibo import learn_fibo_widget
from home_pages import home_pages
class learn_tas_fibo(QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def dashbord(self):
        ...
        self.scrollable_widget =learn_fibo_widget()  # Appel au widget défilable
