...
class Dashbord(QWidget):
    ...
    def content_dahsbord(self):
        ...
        self.button_return_accueil=QPushButton("Page d'acceuil",self)
        self.button_return_accueil.setGeometry(60,90,200,30)
        self.button_return_accueil.setStyleSheet("color:white;""text-align:left;""font-size:15px;""font-family:italic;""background:black;")
        ...
        self.radio1_tas_fibo=QRadioButton("Tas de Fibonacci",self)
        self.radio1_tas_fibo.setGeometry(40,180,150,30)
        self.radio2_B_arbre=QRadioButton("B-ARBRE",self)
        self.radio2_B_arbre.setGeometry(40,210,150,30)
        ...
        self.button_about.setStyleSheet("color:white;""text-align:left;""background:black;""font-size:15px")
        ...
        self.profile_application2=QPushButton("Devlopper Application",self)
        self.profile_application2.setGeometry(60,550,250,30)
        self.profile_application2.setStyleSheet("color:white;""font-size:15px;""font-family:italic;""background:black;""text-align:left;")
        ...
        #logo mundiapolis
        pixampmundiapolis=QPixmap("projet/AlgoTeste.png")
